...
6464, [6466, 6474], [6460, 6462],[6947, 6949],
    ...
    // #10000
    10420, 10417,10356,10416, 10419,10411,10357,10412,10377, 10378,10391, 10572, [10080, 10086], 10331,
...
export const specialReplacements = [
    ...
    { line: 5041, value: '(FOO = Zone.current.fork({onHandleError: Ö })).run(function() {'},
