...
//    3596,
    ...
    //  [4379,4380],
     [4405, 4408], 4544,
    4529, 4533, 4534, 4536,
    [4624,4625  ],  4628, [4646, 4648], 4654, 4653, 
    // 4690,
     4797, 4804, 
    // [4807, 4823], 
    4834,  
...
export let deleteLOC1 = [
    ...
    // #2000
    2749,2948,2747,2947,2011,2126,2007,2975,2147, 2150, [2138, 2140],[2188, 2208],2761, 2326,
...
2709, 2169,
    ...
    // #4000
    4627,4624,4647, 4648,4425,4445,4280,4203,4525, [4415, 4419], 4311, 4407, 4451, 4453,4422, 4413, 4464,[4446, 4448], 4248, 4323, 4324, 4236, 4237,
...
6464, [6466, 6474], [6460, 6462],[6947, 6949],
    ...
    // #8000
    8141,8134, 8917, [8308, 8353], 8306, 8307, 4653, 4656, [8010, 8014],
    ...
    // #10000
    10377, 10378,10391, 10572, [10080, 10086], 10331,
...
export const specialReplacements = [
    ...
    { line: 6431, value: 'this.viewDefFactory = r;'},
    { line: 4628, value: 'this._factories.set(Ö, e[0]);'},
    { line: 5152, value: 'return Ö;'},
    { line: 4622, value: 'function e(e) {'},
    { line: 4644, value: 'function t(t) {'},
    { line: 4646, value: 'this.factory = t;'},
    { line: 4639, value: 'return new Ce(t);'},
    { line: 2935, value: 'function zr( n, r, o) {'},
    { line: 2923, value: 'var r = zr( null, null, t);'},
    { line: 6946, value: 'e.prototype.get = function(e) {'},
    { line: 5109, value: 'return t._componentFactoryResolver.resolveComponentFactory(Ö).create();'},
    ...
    // { line: 2961, value: '(e.parent).nodes[ e.parentNodeDef.parent.nodeIndex].renderElement;'},
    ...
    { line: 1466, value: 'return (new U(({ providers: n }).providers)).get(Ye);'},
    { line: 2127, value: 't[Xt(r.token)] = e[n];'},
    { line: 4834, value: 'onHandleError: function() {'},
    { line: 4797, value: 'this._inner = Zone.current;'},
    { line: 5047, value: 'var n = e.create();'},
    ...
    { line: 7385, value: 'function t( n, r) {'},
    { line: 4030, value: 'function Uo(t, n) {'},
    { line: 4031, value: 'return new Wo(t, n);'},
    { line: 1755, value: 'function yn(e) {'},
    { line: 2131, value: 'function Hn(e, t) {'},
    { line: 2159, value: 'return Ln(e, e._def.providersByKey[r]);'},
    { line: 2145, value: 'if (r === \'_0\') {'},
    { line: 4410, value: 'e.prototype.get = function(e) {'},
    { line: 2276, value: 'return new sr( Ö, r);'},
    { line: 2275, value: 'function ir(  r) {'},
    { line: 6927, value: 'function e( n, r) {'},
    ...
    { line: 4405, value: 't.set(n.provide, {  fn: n.provide,  value: [] });'},
    ...
    { line: 10377, value: 'r.W(4608,Ö, Ö, [Ö,Ö]),'},
    { line: 1433, value: 'function Ge(  n) {'},
    { line: 6367, value: 'var At = Ge( ['},
    { line: 2257, value: 'function Qn(e,  n) {'},
    { line: 2258, value: 'return new Gn(n);'},
    { line: 6459, value: 't.prototype.create = function() {'},
    { line: 4657, value: 't.prototype.create = function() {'},
    { line: 10378, value: 'r.W(6144, Ö, Ö, [Ö]),'},
    { line: 10412, value: 'r.W(131584, r.e, r.e, [r.g]),'},
    { line: 10357, value: 'r.W(512, r.g, r.J, [[8, [a]]]),'},
    ...
    { line: 10355, value: "var Je = r.M( [Ö], function(e) {"},
   ...
   { line: 2278, value: "function hr(e, t) {"},
    ...
    { line: 4658, value: 'return this.factory.create();'},
...
801, 7392,
// 964, 
6806, 1728, 1879, 1178, 4042, 3703,  9387, 9327, 9355, 9320, 
4264, 4111, 3694, 2922, 2928, 5221,
